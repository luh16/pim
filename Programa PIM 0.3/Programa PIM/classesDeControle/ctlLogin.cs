    ...
    public class ctlLogin
    {
            ...
            try
            {
                ...
                if (cursor.HasRows)
                {
                    if (cursor.Read())
                    {
                        ...
                        loginAcessado.nivel = Convert.ToBoolean(cursor["nivel"]);
                        return true;
                    }
                }
            ...
            try
            {
                ...
                if (cursor.HasRows)
                {
                    while(cursor.Read())
                    {
                        ...
                        login.nivel = ((Convert.ToInt32(cursor["nivel"]) == 1) ? true : false);
                        listLogin.Add(login);
                    } 
                }
        ...
        public static bool adicionarUsuario(mdlLogin _mdlLogin)
        {
            ...
            try
            {
                ...
                string sqlQuery = "INSERT INTO Login (usuario, senha, nivel) VALUES (@usuario, @senha, @nivel);";
                ...
                pmtNivel.Value = _mdlLogin.nivel;
            ...
            try
            {
                ...
                if (cursor.HasRows)
                {
                    if (cursor.Read())
                    {
                        ...
                        login.usuario = cursor["usuario"].ToString();
                        login.senha = cursor["senha"].ToString();
                        login.nivel = Convert.ToBoolean(cursor["nivel"]);
                    }
                }
                return login;
            }
        ...
        public static bool EditarUsuario(mdlLogin _mdlLogin, string nomeAtual)
        {
            ...
            try
            {
                ...
                string sqlQuery = "UPDATE Login SET usuario = @usuario, senha = @senha, nivel = @nivel WHERE idLogin = @idLogin;";
